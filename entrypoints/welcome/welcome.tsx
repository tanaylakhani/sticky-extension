    ...
    <div className="container">
      <div className="card reveal">
        ...
        <div className="heading">
          <h1>{profile ? `Welcome, ${profile.name.split(' ')[0]}` : 'Welcome to Sticky'}</h1>
        ...
        {profile && (
          <div className="reveal" style={{ animationDelay: '90ms', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
            <img src={profile.picture} alt={profile.name} width={36} height={36} style={{ borderRadius: 999 }} />
        ...
        <div className="muted reveal" style={{ animationDelay: '160ms' }}>
         Right‑click anywhere to “Create Sticky Notes"
        </div>
